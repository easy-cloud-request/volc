...
use EasyCloudRequest\Volc\Excptions\CouldNotCreateChecksumException;
use GuzzleHttp\Psr7;
use GuzzleHttp\Psr7\Query;
use GuzzleHttp\Psr7\Utils;
use Psr\Http\Message\RequestInterface;
use EasyCloudRequest\Volc\Model\SignParam;
use EasyCloudRequest\Volc\Model\SignResult;

/**
 * source from volcengine SignatureV4
 *
 * @link https://github.com/volcengine/volc-sdk-php/blob/main/src/Base/SignatureV4.php
